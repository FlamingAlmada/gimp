...
#define CROSSHAIR 2
  ...
  gimp_grid_get_offset  (private->grid, &xoffset,  &yoffset);
	...
	grid_visible = gimp_grid_get_visible( private->grid );
	if( grid_visible != gimp_display_shell_get_show_grid (shell) )
		gimp_display_shell_set_show_grid( shell, grid_visible );
